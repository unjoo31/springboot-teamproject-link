...
VALUES
    ...
    (2023, '프론트엔드 개발자 채용', 'React, Vue, Angular 중 1개 이상의 개발 경험', '시스템 소프트웨어 개발 및 공급업', '신입, 경력', now(), '2023-10-31', '백엔드/퍼블리싱/앱 개발 경험 ...', 1),
    (2023, '웹 개발 경력 및 신입사원 채용', '웹 개발 및 시스템 운영', '시스템 소프트웨어 개발 및 공급업', '신입, 경력', now(), '2024-09-01', 'JAVA개발자(Java, JSP, Spring 등)...', 1),
...
>>>>>>> f0e7e32b8e8eb3b67340fa3fffc394f57573163e
